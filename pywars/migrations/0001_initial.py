    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('challenged_bot', models.ForeignKey(related_name='challenged', to='pywars.Bot')),
                ('challenger_bot', models.ForeignKey(related_name='challenger', to='pywars.Bot')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_bot', models.ForeignKey(related_name='current_profile', blank=True, to='pywars.Bot', null=True)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.AddField(
            ...
            name='draw_player1',
            field=models.ForeignKey(related_name='draw_player1', blank=True, to='pywars.UserProfile', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='challenge',
            name='draw_player2',
            field=models.ForeignKey(related_name='draw_playe2', blank=True, to='pywars.UserProfile', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='challenge',
            name='final_challenge',
            field=models.ForeignKey(default=None, blank=True, to='pywars.FinalChallenge', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='challenge',
            name='loser_player',
            field=models.ForeignKey(related_name='loser_player', blank=True, to='pywars.UserProfile', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='challenge',
            name='requested_by',
            field=models.ForeignKey(to='pywars.UserProfile'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='challenge',
            name='winner_bot',
            field=models.ForeignKey(related_name='winner', blank=True, to='pywars.Bot', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='challenge',
            name='winner_player',
            field=models.ForeignKey(related_name='winner_player', blank=True, to='pywars.UserProfile', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='bot',
